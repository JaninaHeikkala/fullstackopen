...
describe('author with most blogs', () => {
  ...
  test('most blogs', () => {
    ...
    assert.strictEqual(authorWithMostBlogs.author, "Robert C. Martin")
    assert.strictEqual(authorWithMostBlogs.blogs, 3)
  })
})
...
describe('blog with most likes', () => {
  ...
  test('most likes', () => {
    ...
    assert.strictEqual(mostLikes.author, "Edsger W. Dijkstra")
